...
class OportunidadesNegocioSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $tipoContratacionBien = DB::table('cat_tipos_contratacion')->where('tipo', 'Bien')->value('id');
        $tipoContratacionServicio = DB::table('cat_tipos_contratacion')->where('tipo', 'Servicio')->value('id');
