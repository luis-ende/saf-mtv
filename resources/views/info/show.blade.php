<x-guest-layout>
    ...
    <div id="cares">
        <div class="dock-wrapper">
            <div id="cares-dock">
                <div class="cares-dock-item" id="create">
                    <a class="item-icon">
                    @svg('register', ['class' => 'h-20 w-20 '])
                    ...
                    <div class="item-content">
                        ...
                        <div class="content-card-items">
                            <div class="card-items">
                                ...
                                <p class="message">Esta plataforma te permite tener acceso a la información de Contrataciones
                                Públicas de la CDMX y recibir notificaciones de los procedimientos de
                                contratación de tu interés. Para registrarte sólo requieres RFC con homoclave y
                                un correo electrónico, así como los datos generales de tu negocio.</p>
                ...
                <div class="cares-dock-item" id="apply">
                    ...
                    <div class="item-content">
                        <div class="icons-content">
                            ...
                            <div class="line-divider"></div>
                            <svg class="w-10 h-10" width="24" height="24" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="cares-dock-item" id="recenter">
                    <a class="item-icon">
                ...
                <div class="cares-dock-item" id="envolve">
                    <a class="item-icon">
                        @svg('document', ['class' => 'h-20 w-20 '])
