            ...
            <div class="content-card-items">
                <div class="card-items">
                    ...
                    <p class="message">Esta plataforma te permite tener <strong>acceso a la información de
                        ...
                        <strong>sugerirán oportunidades de negocio</strong>. Para registrarte sólo requieres RFC con
                ...
                <div class="card-items">
                    ...
                    <p class="message">Al registrarte podrás <strong>crear tu Tiendita Virtual</strong> y así las
        ...
        <div class="d-flex justify-content-center align-items-center">
            ...
            <div class="content-card-items">
                <div class="card-items">
                    ...
                    <p class="message">Ingresa a “Mi Tiendita Virtual” y <strong>conoce todas las oportunidades de
                            negocio</strong> que ofrece el Gobierno de la Ciudad de México <strong>con base en los
                ...
                <div class="card-items">
                    ...
                    <p class="message">Al registrarte recibirás notificaciones de nuevas oportunidades <strong>de
                            acuerdo a tu Perfil
                    ...
                    <div class="card-items">
                        ...
                        <p class="message">Si encontraste alguna oportunidad de negocio y algún procedimiento es de tu
                            interés, tramita tu <a href="#"
                                class="text-[#BC955C] hover:text-[#8B1232] text-decoration-underline">Constancia de
                ...
                <div class="content-card-items">
                    <div class="card-items">
                        ...
                        <p class="message">Al tener tu constancia de Padrón de Proveedores vigente y dependiendo el tipo
                            de procedimiento, puedes cotizar el bien o servicio que la Istitución compradora desee
                            adquirir.
                            <strong>Cotiza por medio del sistema de requisiciones del Gobierno de la CDMX.</strong>
                        </p>
                        <div class="d-flex align-items-center">
                    ...
                    <div class="card-items">
                        ...
                        <p class="message">En caso de resultar participante, con base en las características del
                            procedimiento estipuladas por la Institución compradora, sigue el proceso correspondiente.
                        </p>
                        <div class="d-flex align-items-center">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header admin-title" id="flush-headingOne">
                            <button class="accordion-button collapsed hover:text-[#BC955C]" type="button"
                                ...
                                <svg class="w-6 h-6" fill="currentColor" style="margin-left:10px" viewBox="0 0 24 24">
                                    <path
                            ...
                            <div class="accordion-body border-0">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <svg class="w-5 h-16" xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" stroke-width="1.5" stroke="#bc955c" aria-hidden="true">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header admin-title" id="flush-headingTwo">
                            <button class="accordion-button collapsed hover:text-[#BC955C]" type="button"
                                ...
                                TÉCNICA
                                <svg class="w-6 h-6" fill="currentColor" style="margin-left:55%" viewBox="0 0 24 24">
                                    <path
                                        d="M12 4a8 8 0 100 16 8 8 0 000-16zM2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12zm10-4a1 1 0 011 1v2h2a1 1 0 110 2h-2v2a1 1 0 11-2 0v-2H9a1 1 0 110-2h2V9a1 1 0 011-1z">
                                    </path>
                                </svg>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header admin-title" id="flush-headingThree">
                            <button class="accordion-button collapsed hover:text-[#BC955C]" type="button"
                                ...
                                ECONÓMICA
                                <svg class="w-6 h-6" fill="currentColor" style="margin-left:45%" viewBox="0 0 24 24">
                                    <path
                                        d="M12 4a8 8 0 100 16 8 8 0 000-16zM2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12zm10-4a1 1 0 011 1v2h2a1 1 0 110 2h-2v2a1 1 0 11-2 0v-2H9a1 1 0 110-2h2V9a1 1 0 011-1z">
                                    </path>
                                </svg>
