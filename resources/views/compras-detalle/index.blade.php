    ...
    <div class="bg-white overflow-hidden min-h-screen">
        <div class="py-6 md:px-12 xs:px-6 bg-white border-b border-gray-200 flex flex-col">
            <div class="self-center">                
                <h1 class="text-mtv-secondary font-bold md:text-3xl xs:text-lg">
        ...
        <div x-data="compraDetalleFiltros()" 
             class="flex flex-row items-center justify-center space-x-14 my-4">
            <a href="#" class="mtv-button-secondary-white no-underline">
        ...
        <div id="seccion-datos" class="my-5 md:mx-20 xs:mx-3">
            <x-calendario-compras.detalle-data-table :detalles="$detalles" />
        </div>
    </div>
</x-app-layout>      