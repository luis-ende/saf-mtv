...
Route::post('/carga-productos/producto/{producto}', [CatalogoProductosController::class, 'storeCargaProductosProducto'])->middleware('auth')->name('carga-productos.producto.store');
